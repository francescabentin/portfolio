            ...
            <li
              ...
              <div className="card-links">
                <a
                  ...
                  href="https://francescabentin.github.io/presentation-cards/">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/francescabentin/presentation-cards">
            ...
            <li
              ...
              <div className="card-links">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://francescabentin.github.io/hangman-game-project/">
                  {" "}
                  <Enlace clase="icon-web" />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/francescabentin/hangman-game-project">
                  <img src={iconGit} className="icon-git" alt="git link" />
                </a>
              </div>
            </li>
            ...
            <li
              ...
              <div className="card-links">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://canelo-projects.onrender.com/">
                  {" "}
                  <Enlace clase="icon-web" />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/francescabentin/ProjectDataBase-Api
                        ">
                  <img src={iconGit} className="icon-git" alt="web link" />
                </a>
              </div>
            </li>
          </motion.div>
            ...
            <li
              ...
              <div className="card-links">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://francescabentin.github.io/CoctailFinder-project/">
                  {" "}
                  <Enlace clase="icon-web" />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/francescabentin/CoctailFinder-project">
                  <img src={iconGit} className="icon-git" alt="git link" />
                </a>
              </div>
            </li>
            ...
            <li
              ...
              <div className="card-links">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://francescabentin.github.io/burguer-website/">
                  {" "}
                  <Enlace clase="icon-web" />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/francescabentin/burguer-website">
                  <img src={iconGit} className="icon-git" alt="git link" />
                </a>
              </div>
            </li>
            ...
            <li
              ...
              <div className="card-links">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://francescabentin.github.io/diverlopers-teamProject-1/">
                  {" "}
                  <Enlace clase="icon-web" />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/francescabentin/diverlopers-teamProject-1">
                  <img src={iconGit} className="icon-git" alt="git link" />
                </a>
              </div>
            </li>
            ...
            <li
              ...
              <div className="card-links">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://francescabentin.github.io/simple-website-with-Hero-and-Menu/">
                  {" "}
                  <Enlace clase="icon-web" />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/francescabentin/simple-website-with-Hero-and-Menu">
                  <img src={iconGit} className="icon-git" alt="git link" />
                </a>
              </div>
            </li>
            <li className="projects-li" data-aos="fade-up">
              ...
              <div className="card-links">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://francescabentin.github.io/googleclone/">
                  {" "}
                  <Enlace clase="icon-web" />
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  href="https://github.com/francescabentin/googleclone">
                  <img src={iconGit} className="icon-git" alt="git link" />
                </a>
              </div>
            </li>
